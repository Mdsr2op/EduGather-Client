...
const MessageBody = ({ messages, userId, initialLoad = false }: MessageBodyProps) => {
  ...
  return (
    <div
      ...
      className="bg-dark-3 dark:bg-dark-3 light:bg-light-bg-3 p-2 sm:p-4 h-full overflow-x-hidden overflow-y-auto custom-scrollbar flex flex-col space-y-0 rounded-lg"
    >
      {messages.length === 0 ? (
        <div className="flex items-center justify-center h-full text-light-3 dark:text-light-3 light:text-light-text-3 text-sm sm:text-base">
