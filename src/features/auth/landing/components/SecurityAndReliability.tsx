    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <header className="mb-12 text-center">
          ...
          <p className={`${theme === 'dark' ? 'text-light-3' : 'text-light-text-3'} text-base sm:text-lg max-w-2xl mx-auto`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <article
            className={`flex flex-col space-y-6 p-6 ${theme === 'dark' ? 'bg-dark-4' : 'bg-light-bg-3'} rounded-xl shadow-md transition-transform transform hover:scale-105`}
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3
                  ...
                  className={`text-xl font-semibold ${theme === 'dark' ? 'text-light-1' : 'text-light-text-1'} mb-2`}
                >
                  Encryption &amp; Privacy
                </h3>
                <p className={`${theme === 'dark' ? 'text-light-3' : 'text-light-text-3'} text-sm sm:text-base leading-relaxed`}>
